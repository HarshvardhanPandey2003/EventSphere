// src/pages/owner/EditOwnerProfile.jsx
...
export const EditOwnerProfile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Add avatar if new one uploaded
      if (formData.avatar) {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
        ...
        <div className="bg-slate-800/40 backdrop-blur-xl border border-slate-700/50 rounded-xl p-6 mb-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm">Update your organization details</p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-slate-800/40 backdrop-blur-xl border border-slate-700/50 rounded-xl p-6 space-y-6">
          ...
          <div>
            ...
            />
            <p className="text-slate-400 text-xs mt-2">Upload a new logo to replace the current one</p>
          </div>
